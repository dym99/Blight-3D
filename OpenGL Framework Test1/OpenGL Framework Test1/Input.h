...
public:
	...
	static bool GetKeyPress(KeyCode::Keys iKey); //This returns true when you press and release the keyboard button

	static void ResetKeys();	// Call this to make sure your key functions work! Do it once in your game loop

	static char keyPressedFlag[256];	// Keep track of pressed keys
	static char keyReleasedFlag[256];	// Keep track of released keys
